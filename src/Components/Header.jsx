      ...
      <div className="mx-8 items-center justify-between md:flex">
        ...
        >
            ...
            <li className="my-7 md:ml-8 md:my-0 ">
              <a
                href="/ressources"
                className="flex items-center hover:text-slate-400 duration-300"
                onClick={handleClick}
            ...
            <li className="my-7 w-1/3 md:ml-8 md:my-0 bg-gradient-to-r from-pink-p to-blue-p py-2 px-4 rounded-xl hover:text-slate-300">
              <a
                href="/blog"
                className="flex items-center hover: duration-300"
                onClick={handleClick}
